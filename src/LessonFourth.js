...
export default function LessonFourth() {
            ...
            <View style={styles.container}>
                ...
                <View style={styles.lessons}  >
                    <View style={styles.lessonsPadding}>
                        <Text style={styles.lessonsTitle}>lecture #4</Text>
                        <Text style={styles.lessonsSubtitle}>Introduction to Java programming</Text>
                    </View>
                </View>
