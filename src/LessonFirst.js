...
export default function LessonFirst() {
            ...
            <View style={styles.container}>
                ...
                <View style={styles.lessons}  >
                    <View style={styles.lessonsPadding}>
                        <Text style={styles.lessonsTitle}>lecture #1</Text>
                        <Text style={styles.lessonsSubtitle}>Introduction to Mobile Applications</Text>
                    </View>
                </View>
